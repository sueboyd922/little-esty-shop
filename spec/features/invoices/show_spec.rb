...
RSpec.describe 'invoice show page' do
  before :each do
    ...
    @invoice_item5 = InvoiceItem.create!(item_id: @item1.id, invoice_id: @invoice3.id, quantity: 5, unit_price: 10000, status: "pending",)
  ...
  it "wont display invoice item information for items from other merchants on the invoice show page" do
